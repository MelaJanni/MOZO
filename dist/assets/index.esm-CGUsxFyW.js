 ...
 * limitations under the License.
 */
const N="firebase-installations-store";let $=null;function x(){return $||($=o("firebase-installations-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(N)}})),$}async function q(e,t){const n=A(e),i=(await x()).transaction(N,"readwrite"),a=i.objectStore(N),o=await a.get(n);return await a.put(t,n),await i.done,o&&o.fid===t.fid||M(e,t.fid),t}async function F(e){const t=A(e),n=(await x()).transaction(N,"readwrite");await n.objectStore(N).delete(t),await n.done}async function H(e,t){const n=A(e),i=(await x()).transaction(N,"readwrite"),a=i.objectStore(N),o=await a.get(n),r=t(o);return void 0===r?await a.delete(n):await a.put(r,n),await i.done,!r||o&&o.fid===r.fid||M(e,r.fid),r}
/**
 * @license
 * Copyright 2019 Google LLC
 *
